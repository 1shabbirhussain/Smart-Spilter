...
const ExpenseSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'splitType': PropertySchema(
      ...
      name: r'splitType',
      type: IsarType.byte,
      enumMap: _ExpensesplitTypeEnumValueMap,
    ),
    r'splits': PropertySchema(
      id: 7,
      name: r'splits',
      type: IsarType.objectList,
      target: r'ExpenseSplit',
    ),
  ...
  links: {},
  embeddedSchemas: {r'ExpenseSplit': ExpenseSplitSchema},
  getId: _expenseGetId,
...
int _expenseEstimateSize(
  ...
  {
    final offsets = allOffsets[ExpenseSplit]!;
    for (var i = 0; i < object.splits.length; i++) {
      final value = object.splits[i];
      bytesCount += ExpenseSplitSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _expenseSerialize(
  ...
  writer.writeLong(offsets[5], object.paidById);
  writer.writeByte(offsets[6], object.splitType.index);
  writer.writeObjectList<ExpenseSplit>(
    offsets[7],
    allOffsets,
    ExpenseSplitSchema.serialize,
    object.splits,
  );
...
Expense _expenseDeserialize(
  ...
  final object = Expense(
    ...
    groupId: reader.readLong(offsets[3]),
    id: id,
    notes: reader.readStringOrNull(offsets[4]),
    paidById: reader.readLong(offsets[5]),
    splitType:
        _ExpensesplitTypeValueEnumMap[reader.readByteOrNull(offsets[6])] ??
            SplitType.equal,
    splits: reader.readObjectList<ExpenseSplit>(
          offsets[7],
          ExpenseSplitSchema.deserialize,
          allOffsets,
          ExpenseSplit(),
        ) ??
        [],
...
P _expenseDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readLong(offset)) as P;
    case 6:
      return (_ExpensesplitTypeValueEnumMap[reader.readByteOrNull(offset)] ??
          SplitType.equal) as P;
    case 7:
      return (reader.readObjectList<ExpenseSplit>(
            offset,
            ExpenseSplitSchema.deserialize,
            allOffsets,
            ExpenseSplit(),
...
const _ExpensesplitTypeEnumValueMap = {
  'equal': 0,
  'custom': 1,
  'percentage': 2,
};
const _ExpensesplitTypeValueEnumMap = {
  0: SplitType.equal,
  1: SplitType.custom,
...
extension ExpenseQueryWhereSort on QueryBuilder<Expense, Expense, QWhere> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhere> anyGroupId() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryWhere on QueryBuilder<Expense, Expense, QWhereClause> {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> groupIdEqualTo(
      int groupId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> groupIdNotEqualTo(
      int groupId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> groupIdGreaterThan(
    int groupId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> groupIdLessThan(
    int groupId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterWhereClause> groupIdBetween(
    int lowerGroupId,
    int upperGroupId, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> groupIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'groupId',
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> groupIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> groupIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> groupIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paidByIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'paidById',
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paidByIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paidByIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> paidByIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> splitTypeEqualTo(
      SplitType value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> splitTypeGreaterThan(
    SplitType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> splitTypeLessThan(
    SplitType value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> splitTypeBetween(
    SplitType lower,
    SplitType upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByGroupId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'groupId', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByGroupIdDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByPaidById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidById', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByPaidByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidById', Sort.desc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortBySplitType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'splitType', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortBySplitTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByGroupId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'groupId', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByGroupIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'groupId', Sort.desc);
    });
  }
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByPaidById() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidById', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByPaidByIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'paidById', Sort.desc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenBySplitType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'splitType', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenBySplitTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'splitType', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByGroupId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByPaidById() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'paidById');
    });
  }

  QueryBuilder<Expense, Expense, QDistinct> distinctBySplitType() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, int, QQueryOperations> groupIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, int, QQueryOperations> paidByIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'paidById');
    });
  }

  QueryBuilder<Expense, SplitType, QQueryOperations> splitTypeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'splitType');
    });
  }

  QueryBuilder<Expense, List<ExpenseSplit>, QQueryOperations> splitsProperty() {
    return QueryBuilder.apply(this, (query) {
...
const ExpenseSplitSchema = Schema(
  name: r'ExpenseSplit',
  id: -6660237893555226298,
  properties: {
    r'amount': PropertySchema(
      id: 0,
      name: r'amount',
  ...
  estimateSize: _expenseSplitEstimateSize,
  serialize: _expenseSplitSerialize,
  deserialize: _expenseSplitDeserialize,
  deserializeProp: _expenseSplitDeserializeProp,
);

int _expenseSplitEstimateSize(
  ExpenseSplit object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
ExpenseSplit _expenseSplitDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ExpenseSplit(
    amount: reader.readDoubleOrNull(offsets[0]) ?? 0.0,
    memberId: reader.readLongOrNull(offsets[1]) ?? 0,
  );
  return object;
}

P _expenseSplitDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension ExpenseSplitQueryFilter
    on QueryBuilder<ExpenseSplit, ExpenseSplit, QFilterCondition> {
  QueryBuilder<ExpenseSplit, ExpenseSplit, QAfterFilterCondition> amountEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ExpenseSplit, ExpenseSplit, QAfterFilterCondition>
      amountGreaterThan(
    double value, {
    bool include = false,
    double epsilon = Query.epsilon,
  ...
  QueryBuilder<ExpenseSplit, ExpenseSplit, QAfterFilterCondition> amountBetween(
    double lower,
    double upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseSplitQueryObject
    on QueryBuilder<ExpenseSplit, ExpenseSplit, QFilterCondition> {}
